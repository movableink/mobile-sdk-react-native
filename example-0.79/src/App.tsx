...
import { StyleSheet, View, Text, Linking, Button, useColorScheme, ActivityIndicator } from 'react-native';
...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      <Text style={colorScheme === 'dark' ? styles.textDark : styles.textLight}>Resolved Link: {link}</Text>
